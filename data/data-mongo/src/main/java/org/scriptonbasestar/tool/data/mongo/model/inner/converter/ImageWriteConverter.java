...
import org.scriptonbasestar.tool.data.mongo.model.inner.model.ImageInnerModel;
 ...
 */
@WritingConverter
public class ImageWriteConverter
	implements Converter<ImageInnerModel, DBObject> {
	@Override
