...
import org.scriptonbasestar.tool.data.mongo.model.inner.model.DateTimeScopeInnerModel;
 ...
 */
@ReadingConverter
public class DateTimeScopeReadConverter
	implements Converter<DBObject, DateTimeScopeInnerModel> {
	@Override
