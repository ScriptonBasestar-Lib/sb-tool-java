...
import com.scriptonbasestar.tool.data.mongo.model.inner.model.AddressInnerModel;
 ...
 */
@ReadingConverter
public class AddressReadConverter implements Converter<DBObject, AddressInnerModel> {
	@Override
