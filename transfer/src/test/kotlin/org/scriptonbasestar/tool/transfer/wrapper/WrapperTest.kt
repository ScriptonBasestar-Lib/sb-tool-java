...
class WrapperTest {
	...
	fun wrapperCreationTest(){
		var wrapper1_1 = SBListResponseWrapper<Long>().data(SetBuilder.create<Long>().add(3).build()).success(true)
		var wrapper1_2 = SBListResponseWrapper<String>().data(SetBuilder.create<String>().add("ddd").build()).success(true)
		println(wrapper1_1)
		println(wrapper1_2)

		var wrapper2_1 = SBListResponseWrapper.create().data(SetBuilder.create<Long>().add(3).build()).success(true)
