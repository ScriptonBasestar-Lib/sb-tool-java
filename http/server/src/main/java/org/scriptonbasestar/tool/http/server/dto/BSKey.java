...
public class BSKey {
	...
	public BSKey(String category1, String category2, String endpoint){
	...
	public static BSKey create(String category1, String category2, String endpoint){
		return new BSKey(category1, category2, endpoint);
	}
}
