...
//			"C0002"->{"invest/funding_start"}
			//투자자 투자완료
			"C0005" -> {
				"invest/invest_success"
			}
			//투자자 투자취소
			"C0006" -> {
				"invest/invest_cancel"
			}
			//투자상품 수익금 지급
			"C0007" -> {
				"invest/repay"
			...
			//추심금 지급
			"C0012" -> {
				"invest/collect_repay"
			}
			//예치금 출금
			"D0001" -> {
				"member/balance_withdraw"
			}
			else -> {
				throw Exception("예상치 못한 오류 발생. 존재하지 않는 코드 요청. $code")
			}
		}
